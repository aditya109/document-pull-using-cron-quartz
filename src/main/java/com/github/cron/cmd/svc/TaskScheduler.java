package com.github.cron.cmd.svc;
...
public class TaskScheduler {
    ...
    public void runScheduler(Object job) throws SchedulerException, ParseException, InterruptedException {
        JobDetail job1 = JobBuilder.newJob((Class<? extends Job>) job.getClass())
